...
export const metadata: Metadata = {
  title: 'Our Work | 새벽별 파운데이션',
  description: '우리가 만들고 있는 것',
};
  ...
  return (
    <main className="min-h-screen bg-white pt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-5xl font-bold text-slate-900 mb-6">Our Work</h1>
        <p className="text-2xl text-slate-600 mb-16">우리가 만들고 있는 것</p>

        {/* Intro */}
        <div className="max-w-4xl mb-20">
          <p className="text-xl text-slate-600 leading-relaxed">
            새벽별 파운데이션은 기술을 통해 교육 평등을 실현합니다. 우리의 첫
            번째 프로젝트는 '샛별(Saetbyeol)'입니다.
          </p>
        </div>
        ...
        <div className="mb-32">
          <div className="bg-slate-50 border border-slate-200 rounded-3xl p-12">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              샛별은 Khan Academy의 Khanmigo에서 영감을 받아, 한국 교육 환경에
              맞게 재설계된 AI 학습 도구입니다. 하지만 단순히 답을 알려주는
              것이 아닙니다.
            </p>
          </div>
        </div>
