              ...
              <div className="bg-slate-50 rounded-2xl shadow-xl p-8 border border-slate-200">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-10 h-10 bg-slate-900 rounded-full" />
                    <div className="flex-1 bg-white rounded-2xl rounded-tl-none p-4 border border-slate-200">
                  ...
                  <div className="flex items-start gap-3 flex-row-reverse">
                    ...
                    <div className="flex-1 bg-slate-900 text-white rounded-2xl rounded-tr-none p-4">
